...
@Entity
@Table(
        name = "sandbox_execution_activities",
        indexes = {@Index(name = "idx_sandbox_execution_activities_execution", columnList = "execution_id, sequence")})
public class SandboxExecutionActivity {
    ...
    public SandboxExecutionActivity() {}
